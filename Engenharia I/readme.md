...
<h4> Requisitos Funcionais (tarefas ou ações do sistema): </h4>
<p>
<ul>
  <li>Comprar grande quantidades de pares de tênis;</li>
  <li>Realizar busca de um tênis insirindo nome, marca ou tamanho;</li>
  <li>Visualizar uma breve descrição dos pares antes de comprar.</li>
</ul>
</p>


<h4> Requisitos Não Funcionais (qualidades do sistema): </h4>
<p>
<ul>
  <li>Usabilidade do sistema - interface simples e intuitiva;</li>
  <li>Grandes diversidades de pares;</li>
  <li>Temas Light e Dark;</li>
</ul>
</p>
